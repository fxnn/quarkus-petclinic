...
public class VetResourceTest {
  ...
  private static final String JSON_HENRY_STEVENS =
      "{\"id\":1,\"firstName\":\"Henry\",\"lastName\":\"Stevens\",\"nrOfSpecialties\":0,\"specialties\":[]}";
  private static final String JSON_LIST_ALL =
      "[{\"id\":1,\"firstName\":\"Henry\",\"lastName\":\"Stevens\",\"nrOfSpecialties\":0,\"specialties\":[]},{\"id\":2,\"firstName\":\"Sharon\",\"lastName\":\"Jenkins\",\"nrOfSpecialties\":0,\"specialties\":[]}]";
  ...
  public void testFindAllVets() {
    given().when().get("/vets").then().statusCode(200).body(is(getJsonFindAllVets()));
  }
